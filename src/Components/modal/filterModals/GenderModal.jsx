...
const GenderModal = ({ currentView, setCurrentView, previousFilter, setPreviousFilter, setSelectedFilter, setConditiontype, conditiontype }) => {
    const conditions = [
        "Includes_g",
    ...
    return (
        <div>
            {currentView === "Gender" && <div className="space-y-2">
